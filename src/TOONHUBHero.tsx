...
const IMAGES = [
  {
    src: '/images/toys/1.webp',
    bg: '#F4845F',
    panel: '#F79B7F',
  },
  {
    src: '/images/toys/2.webp',
    bg: '#6BBF7A',
    panel: '#85CC92',
  },
  {
    src: '/images/toys/3.webp',
    bg: '#E882B4',
    panel: '#ED9DC4',
  },
  {
    src: '/images/toys/4.webp',
    bg: '#6EB5FF',
    panel: '#8DC4FF',
  },
];
  ...
  const navigate = useCallback(
    (direction: 'next' | 'prev') => {
      ...
      setActiveIndex((prev) => {
        ...
        return (prev + 3) % 4; // +3 instead of -1 to avoid negative
      });
      ...
      <div className="relative w-full" style={{ height: '100vh', overflow: 'hidden' }}>
        ...
        <div className="absolute inset-0" style={{ zIndex: 3 }}>
          {IMAGES.map((image, index) => {
            // Determine role
            let role = '';
            if (index === roles.center) role = 'center';
            else if (index === roles.left) role = 'left';
        ...
        >
          ...
          <p
            className="hidden sm:block sm:mb-5 sm:text-sm"
            style={{
              fontSize: '12px',
              color: 'white',
              opacity: 0.85,
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex items-center justify-center transition-all duration-150 hover:scale-108"
              style={{
